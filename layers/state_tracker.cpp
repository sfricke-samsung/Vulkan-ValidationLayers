...
void ValidationStateTracker::RecordGetImageMemoryRequiementsState(VkImage image, const VkImageMemoryRequirementsInfo2 *pInfo,
                                                                  VkMemoryRequirements *pMemoryRequirements) {
...
void ValidationStateTracker::PostCallRecordGetImageMemoryRequirements(VkDevice device, VkImage image,
                                                                      VkMemoryRequirements *pMemoryRequirements) {
    RecordGetImageMemoryRequiementsState(image, nullptr, pMemoryRequirements);
}
...
void ValidationStateTracker::PostCallRecordGetImageMemoryRequirements2(VkDevice device, const VkImageMemoryRequirementsInfo2 *pInfo,
    ...
    RecordGetImageMemoryRequiementsState(pInfo->image, pInfo, &pMemoryRequirements->memoryRequirements);
}
